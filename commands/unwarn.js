...
module.exports = {
    run: async (message, args, client) => {
        ...
        if (warnIndex < 0 || !client.db.warns[member.id][warnIndex]) return message.channel.send('**Ce warn n\'existe pas**:x:')
        ...
        message.channel.send(`${member} **a été unwarn pour** ${reason} :white_check_mark:
